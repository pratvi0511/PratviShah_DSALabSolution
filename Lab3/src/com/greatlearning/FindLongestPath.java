...
public class FindLongestPath {
	...
	public static ArrayList<Integer> findLongestPath(Node root){
		//If the root is null which means there is no binary tree then return empty list
		if(root == null) {
		...
		//comparing the size of the two array list and accordingly inserting the current node
